<?php if(count($request_list) > 0) { ?>
    <?php foreach($request_list as $list) { ?>
        <div id="request-box-<?php echo $list['user_id'] ?>" class="connection-card">
            ...
            <div class="card-body">
                ...
                <div class="card-socialbutton-content">
                    <div class="socialbutton-content" data-user-id="<?php echo $list['user_id'] ?>" data-client-id="<?php echo $list['profile_code'] ?>">
                        <button type="button" name="button" class="btn btn-follow btn-con-friends" rel="accept_friend_request"><i class="icon i-paw"></i> Accept</button>
                        <button type="button" name="button" class="btn btn-remove btn-remove-request" data-type="friend_request" data-id="<?php echo $list['user_id'] ?>"><i class="icon i-heart"></i> Remove</button>
                    </div>
                </div>
